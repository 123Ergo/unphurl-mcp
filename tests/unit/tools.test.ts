...
describe("tool descriptions", () => {
  ...
  it("create_profile mentions '22' signals and lists all weight keys in input schema", () => {
    const tool = registeredTools.get("create_profile")!;
    expect(tool.description).toContain("22");
    // All 22 weight keys are listed in the weights parameter description, not the tool description
  ...
  it("show_defaults mentions '22 scoring signals'", () => {
...
describe("show_defaults handler", () => {
  it("returns hardcoded data with 22 signals (no API call)", () => {
