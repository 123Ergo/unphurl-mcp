...
Profiles only override specific weights. Any signal not specified in a profile uses the default weight. Use show_defaults to see all 12 signals and their default weights.`,
      inputSchema: {},
    },
    async () => {
...
Use show_defaults to see all 12 signals with their default weights and descriptions before creating a profile. Use check_url or check_urls with the "profile" parameter to score results with this profile.
...
See the LinkCheck API documentation for all 19 use case weight examples.`,
      inputSchema: {
        ...
        weights: z
          ...
          .describe(
            "Custom weights for scoring signals. Only include signals you want to override. Available signals: brand_impersonation (default 40), domain_age_7 (25), domain_age_30 (15), domain_age_90 (5), ssl_invalid (10), http_only (5), redirects_3 (10), redirects_5 (25), chain_incomplete (15), parked (10), compound (10), phishing_floor (80)."
          ),
      },
    },
    async ({ name, weights }) => {
...
Use list_profiles to see your current profiles before deleting.`,
  ...
  server.registerTool(
    "show_defaults",
    {
      description: `Show all 12 scoring signals with their default weights and descriptions. This is the baseline scoring that applies when no custom profile is specified.
