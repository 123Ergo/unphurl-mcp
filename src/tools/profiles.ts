...
Use list_profiles to see your current profiles before deleting.`,
  ...
  server.registerTool(
    "show_defaults",
    {
      description: `Show all 23 scoring signals with their default weights and descriptions. This is the baseline scoring that applies when no custom profile is specified.
